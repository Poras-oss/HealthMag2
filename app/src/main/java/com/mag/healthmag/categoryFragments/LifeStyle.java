...
public class LifeStyle extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new lifestyleadapter();
        recyclerView.setAdapter(adapter);
        //------------------------------------------------------------------------------------------------

    }

    private class lifestyleadapter extends RecyclerView.Adapter<lifestyleadapter.lifestyleholder> {
        ...
        @NonNull
        @Override
        public lifestyleholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(getContext()).inflate(R.layout.big_mag,parent,false);
            return new lifestyleholder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull lifestyleholder holder, int position) {
