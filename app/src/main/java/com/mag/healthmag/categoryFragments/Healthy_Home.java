 ...
 */
public class Healthy_Home extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new healthyhomeadapter();
        recyclerView.setAdapter(adapter);
        //------------------------------------------------------------------------------------------------

    }
    private class healthyhomeadapter extends RecyclerView.Adapter<healthyhomeadapter.healthyhomeholder> {
        ...
        @NonNull
        @Override
        public healthyhomeholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(getContext()).inflate(R.layout.big_mag,parent,false);
            return new healthyhomeholder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull healthyhomeholder holder, int position) {
        ...
        public class healthyhomeholder extends RecyclerView.ViewHolder {
            public ImageView imageView;
            public LinearLayout linearLayout;
            public healthyhomeholder(@NonNull View itemView) {
                super(itemView);
